---
title: "Analysis of Readiness Examination Scores: CVC"
date: "10/30/2018"
output:
  word_document: 
...
* The MCQ RE scores for Grade 8 continue to improve in general with the exception of Integrated Science, where the scores are in a downward trend since 2016.
* There are remarkable improvements in the Grade 8 non-MCQ RE scores for Filipino, and Math. However, there is a noticeable downward shift in the Social Science non-MCQ scores. Such drop is quite remarkable in Social Science.
* The Grade 10 MCQ scores for improved in all of the subjects with the exception of Physics, which had a noticeable decline. There are remarkable increases in the scores for Biology, English, Filipino, Social Science and Statistics. On the other hand, there is an appreciable decrease in the Physics scores. Such decrease is also the trend, system-wide.
* In terms of the Grade 10 non-MCQ tests, English, Filipino, Chemistry, and Social Science have had a remarkable increase in the distribution of scores. The others either remained the same or have become lower than the previous year. Remarkable in these decreases are that of Biology and Mathematics.
* In general, the scores for the MCQ tests are normally distributed. This means that, in the MCQ tests, about 68% of the students scored 1 standard deviation about the mean score. 
* Visible skewness in the distribution of scores can be found in some of the Non-MCQ scores. Notably:
  ...
  - in Grade 10 Biology, English, and Filipino non-MCQ test scores, more students scored lower than the corresponding campus mean.
* In the following analyses, 50% is used to benchmark the scores of the students. There are two ways of viewing this benchmark: the subjects are easy or the students are not "ready" in more than 50% of the skills covered in the tests. These two views may not be mutually exclusive of each other. Also, the 50% benchmark is arbitrary and can be set by the subject-matter experts. However, there is the danger of setting the benchmark too low in order to make it appear that the students performed well when in fact they fail to show readiness in most skills required by the items that they fail to answer correctly[^1]. 
  ...
  - In terms of the non-MCQ tests for Grade 8, only 42% of the test-takers scored above 50% in Social Science, making it the subject with the lowest proportion of test-takers scoring at least 50%. On the other hand, 94% of the test-takers got at least 50% of the items correctly in the Filipino non-MCQ test.
  - More than 50% of the Grade 10 test-takers scored 50% or above in all Grade 10 MCQ subjects except Physics (37%) and Mathematics (34%). On the other hand, almost all test-takers got a score of more than 50% in Filipino (99%), while all test-takers got at least 50% in English.
  - In all of the Grade 10 non-MCQ tests in STEM, except for Chemistry, at most only 15% of the test-takers got scores of at least 50%. In Chemistry, there were 51% of the test-takers who scored more than 50%. More worrisome is the fact that in all of the computational subjects, at most 15% got scores above 50% (Math---2%; Stat---7%; Physics---15%). However, this is not surprising, as this has been the trend for these subjects in the past years.
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "CVC"]
```
