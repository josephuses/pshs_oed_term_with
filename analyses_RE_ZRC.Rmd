---
title: "Analysis of Readiness Examination Scores: ZRC"
date: "10/30/2018"
output:
  word_document: 
...
* Integrated Science has the lowest MCQ RE scores. The test-takers performed the best in the English MCQ test.
* In the non-MCQ scores, the test-takers had the best performance in Filipino but fared worst in both Math and English.
...
* Visible skewness in the distribution of scores can be found in some of the Non-MCQ scores. Notably, in all subjects, except for Filipino, there were more students that scored less than the campus mean score.
* In the following analyses, 50% is used to benchmark the scores of the students. There are two ways of viewing this benchmark: the subjects are easy or the students are not "ready" in more than 50% of the skills covered in the tests. These two views may not be mutually exclusive of each other. Also, the 50% benchmark is arbitrary and can be set by the subject-matter experts. However, there is the danger of setting the benchmark too low in order to make it appear that the students performed well when in fact they fail to show readiness in most skills required by the items that they fail to answer correctly[^1]. 
  - In terms of the MCQ test scores, more than half of the students who took the tests got more than 50% of the items correctly in all tests, except for Integrated Science (49%). On the other hand, 87% of the students scored at least 50% in English.
  - In terms of the non-MCQ tests, only 15% of the test-takers scored at least 50% in Mathematics, and only 22% of the test-takers scored at least 50% in Social Science. On the other hand, there were 87% of the test takers who got at least 50% in Filipino.
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "ZRC"]
```
...
### Distribution of Grade 8 MCQ scores in the 2017 RE
