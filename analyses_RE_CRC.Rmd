---
title: "Analysis of Readiness Examination Scores: CRC"
date: "10/30/2018"
output:
  word_document: 
...
* The MCQ RE scores for Grade 8 continue to improve in general with the exception of Integrated Science, where the distribution of scores are following a downward trend.
* There are remarkable improvements in the Grade 8 non-MCQ RE scores for Filipino, and Mathematics. However, there is a noticeable downward shift in the English non-MCQ scores. 
* For the Grade 10 MCQ tests, the students performed the best in Filipino.
* In terms of the Grade 10 non-MCQ tests, the test-takers performed best in English and worst in Mathematics.
* In general, the scores for the MCQ tests are normally distributed, except for Grade 10 Filipino, in which noticeably more students scored higher than the campus mean. This means that, in the MCQ tests, about 68% of the students scored 1 standard deviation about the mean score. 
* Visible skewness in the distribution of scores can be found in some of the Non-MCQ scores. Notably:
  ...
  - in Grade 10 Social Science Non-MCQ test, more students got scores that are higher than the mean score.
* In the following analyses, 50% is used to benchmark the scores of the students. There are two ways of viewing this benchmark: the subjects are easy or the students are not "ready" in more than 50% of the skills covered in the tests. These two views may not be mutually exclusive of each other. Also, the 50% benchmark is arbitrary and can be set by the subject-matter experts. However, there is the danger of setting the benchmark too low in order to make it appear that the students performed well when in fact they fail to show readiness in most skills required by the items that they fail to answer correctly[^1]. 
  - In terms of the MCQ test scores for Grade 8, more than half of the students who took the tests got more than 50% of the items correctly in all tests except for Mathematics (34%) and Integrated Science (20%). 
  - In terms of the non-MCQ tests for Grade 8, only 32% of the test-takers scored above 50% in Social Science, which is the lowest among all of the subjects. On the other hand, 97% of the test-takers got at least 50% of the items correctly in the Filipino non-MCQ test.
  - More than 50% of the Grade 10 test-takers of the MCQ tests scored 50% or above in all Humanities subjects (English---79%; Filipino---78%; Social Science---78%). In STEM subjects, most students did not get at least 50% of the items correctly (Chemistry---34%; Statistics---22%; Mathematics---19%; Physics---14%);
  - In all of the Grade 10 non-MCQ tests in STEM, below 30% of the test-takers got scores of at least 50%. More worrisome is the fact that in all of the computational subjects, less than 30% got scores above 50% (Math---0%; Stat---12%; Physics---26%). 
  ...
  - The students also performed comparably in Non-MCQ tests in general. 
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "CRC"]
```
