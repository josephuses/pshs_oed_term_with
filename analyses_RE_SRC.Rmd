---
title: "Analysis of Readiness Examination Scores: SRC"
date: "10/30/2018"
output:
  word_document: 
...
* All of the Grade 10 MCQ scores improved from the 2017 scores, with remarkable improvements in Filipino and Mathematics. Notably, the scores in Social Science also improved from the scores in 2017, which is a departure from the system-wide trend where a decrease in scores is observed.
* In terms of the Grade 10 non-MCQ tests, the distributions of scores improved from 2017 except for Chemistry, Mathematics, and Physics. Most notably, the only three students got a different score from the rest in Chemistry, who got the same low score.
* In general, the scores for the MCQ tests are normally distributed. This means that, in the MCQ tests, about 68% of the students scored 1 standard deviation about the mean score. Visible skewness in the distribution of scores can be found in some of the Non-MCQ scores. Notably:
  - in Grade 8 Filipino and Mathematics Non-MCQ test, more students got scores that are higher than the mean score;
  - an appreciable number of students scored lower than the mean scores in the Grade 10 Biology, Chemistry, Math, and Statistics Non-MCQ tests.
* In the following analyses, 50% is used to benchmark the scores of the students. There are two ways of viewing this benchmark: the subjects are easy or the students are not "ready" in more than 50% of the skills covered in the tests. These two views may not be mutually exclusive of each other. Also, the 50% benchmark is arbitrary and can be set by the subject-matter experts. However, there is the danger of setting the benchmark too low in order to make it appear that the students performed well when in fact they fail to show readiness in most skills required by the items that they fail to answer correctly[^1]. 
  - In terms of the MCQ test scores for Grade 8, more than half of the students who took the tests got more than 50% of the items correctly in Biology (99%), English (95%), Social Science (88%), and Biology (80%). On the other hand, less than 50% of the students scored less than 50% in Chemistry (46%), Statistics (35%), Mathematics (28%), and Physics (14%).
  - In terms of the non-MCQ tests for Grade 8, only 33% of the test-takers scored above 50% in Social Science, which is the lowest among all of the subjects. On the other extreme side, 95% of the test-takers got at least 50% of the items correctly in the Filipino non-MCQ test.
  ...
  - In terms of the Grade 10, non-MCQ tests, the students were only able to score above 50% in Social Science (66%), Filipino (94%), and English (100%). Less than 20% of the students scored at least 50% in Statistics (18%), Physics (16%), Biology (11%), Mathematics (11%), and Chemistry (5%).
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "SRC"]
```
