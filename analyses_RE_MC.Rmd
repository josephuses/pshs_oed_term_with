---
title: "Analysis of Readiness Examination Scores: MC"
date: "10/30/2018"
output:
  word_document: 
...
* The MCQ RE scores for Grade 8 continue to improve in general with the exception of Integrated Science, where the scores are significantly lower compared to the 2017 scores.
* There are remarkable improvements in the Grade 8 non-MCQ RE scores for Filipino. However, there is a noticeable downward shift in the Social Science, Integrated Science and English non-MCQ scores. Such drop is quite remarkable in Social Science, which is also the trend system-wide.
* The Grade 10 MCQ scores for Biology, English, Filipino, and Mathematics follow an increasing trend. There are remarkable increases in the scores for Biology and Filipino. On the other hand, there is an appreciable decrease in the Physics scores. Such decrease is also the trend, system-wide.
* In terms of the Grade 10 non-MCQ tests, only English and Chemistry have had a remarkable increase in the distribution of scores. The others either remained the same or have become lower than the previous year. Noticeably, Mathematics scores and Statistics scores are lower when compared to the previous year's RE scores.
* In general, the scores for the MCQ tests are normally distributed, except for Filipino, where more students scored higher than the campus mean score. This means that, in the MCQ tests, about 68% of the students scored 1 standard deviation about the mean score. 
* Visible skewness in the distribution of scores can be found in some of the Non-MCQ scores. Notably:
  - in Grade 8 and Grade 10 Filipino Non-MCQ test, more students got scores that are higher than the mean score;
  - an appreciable number of students scored lower than the mean scores in the Grade 10 Mathematid and Physics Non-MCQ tests.
* In the following analyses, 50% is used to benchmark the scores of the students. There are two ways of viewing this benchmark: the subjects are easy or the students are not "ready" in more than 50% of the skills covered in the tests. These two views may not be mutually exclusive of each other. Also, the 50% benchmark is arbitrary and can be set by the subject-matter experts. However, there is the danger of setting the benchmark too low in order to make it appear that the students performed well when in fact they fail to show readiness in most skills required by the items that they fail to answer correctly[^1]. 
  - In terms of the MCQ test scores for Grade 8, more than half of the students who took the tests got more than 50% of the items correctly in all tests. 
  - In terms of the non-MCQ tests for Grade 8, only 20% of the test-takers scored above 50% in Social Science, which is the lowest among all of the subjects. On the other extreme side, 95% of the test-takers got at least 50% of the items correctly in the Filipino non-MCQ test.
  - More than 50% of the Grade 10 test-takers scored 50% or above in all Grade 10 MCQ subjects. However, Mathematics (53%) and Statistics (59%) also have noticeably low percentages of test-takers that scored above 50%.
  - In the non-MCQ tests in STEM, except for Chemistry, below 50% of the test-takers got scores of at least 50%. However, even in Chemistry, there were only 54% of the test-takers who scored more than 50%. More worrisome is the fact that in all of the computational subjects, less than 25% got scores above 50% (Math---17%; Stat---12%; Physics---23%). However, this is not surprising as this has been the trend for these subjects in the past years.
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "MC"]
```
