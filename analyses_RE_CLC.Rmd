---
title: "Analysis of Readiness Examination Scores: CLC"
date: "10/30/2018"
output:
  word_document: 
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "CLC"]
```
