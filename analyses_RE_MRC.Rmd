---
title: "Analysis of Readiness Examination Scores: MRC"
date: "10/30/2018"
output:
  word_document: 
...
* The students got the highest MCQ RE scores in Filipino and the lowest in Mathematics.
* In terms of the non-MCQ RE scores, the students have the same performance in all of the subjects except for Social Science, where the students performed the worst.
* In general, the scores for the MCQ tests are normally distributed. This means that, in the MCQ tests, about 68% of the students scored 1 standard deviation about the mean score. However, visible skewness in the distribution of English scores (where more students scored more than the campus mean score) and in the distribution of Mathematics scores (where more students scored lower than the campus  mean score) can be observed. 
* Visible skewness in the distribution of scores can be found in all of the Non-MCQ scores. Notably:
  - In English, Filipino and Social Science, more students got scores that are lower than the campus mean score;
  - In Integrated Science and Mathematiccs, more students got scores that are lower than the campus mean score.
* In the following analyses, 50% is used to benchmark the scores of the students. There are two ways of viewing this benchmark: the subjects are easy or the students are not "ready" in more than 50% of the skills covered in the tests. These two views may not be mutually exclusive of each other. Also, the 50% benchmark is arbitrary and can be set by the subject-matter experts. However, there is the danger of setting the benchmark too low in order to make it appear that the students performed well when in fact they fail to show readiness in most skills required by the items that they fail to answer correctly[^1]. 
  - In terms of the MCQ test scores for Grade 8, more than half of the students who took the tests got more than 50% of the items correctly in the English and Filipino tests. However, less than 50% of the test takers scored at least 50% in Social Science (48%), Integrated Science (31%), and Mathematics (17%).
  - In terms of the non-MCQ tests, more than 50% of the students got scores that are higher than 50% in all subjects except in Social Science (35%). This is also the trend system-wide.
* It is also not surprising that the students performed worse in the STEM subjects than in the Humanities subjects, in the MCQ test. But the gap in performance is alarming, nonetheless. But there is no noticeable difference in the non-MCQ test scores between Humanities and STEM subjects.
* There is no noticeable difference in the distribution of scores between MCQ and non-MCQ scores.
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "MRC"]
```
