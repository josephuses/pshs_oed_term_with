---
title: "Analysis of Readiness Examination Scores: SMC"
date: "10/30/2018"
output:
  word_document: 
...
* There are remarkable improvements in the Grade 8 non-MCQ RE scores for Filipino, IS, and Math. However, there is a noticeable downward shift in the Social Science and English non-MCQ scores. Such drop is quite remarkable in Social Science.
* The Grade 10 MCQ scores for Biology, English, Filipino, Social Science, and Statistics follow an increasing trend. There are remarkable increases in the scores for Biology, English, and Filipino. On the other hand, there is an appreciable decrease in the Physics scores. Such decrease is also the trend, system-wide.
* In terms of the Grade 10 non-MCQ tests, only English, Filipino, and Social Science have had a remarkable increases in the distribution of scores. The others either remained the same or have become lower than the previous year. Appreciable decreases can be observed in Mathematics and Physics.
* In general, the scores for the MCQ tests are normally distributed. This means that, in the MCQ tests, about 68% of the students scored 1 standard deviation about the mean score. Visible skewness in the distribution of scores can be found in some of the Non-MCQ scores. Notably:
  ...
  - An appreciable number of students scored lower than the mean scores in the Grade 10 Biology, Chemistry, and English Non-MCQ tests. On the other, more students scored higher than the mean in English.
* In the following analyses, 50% is used to benchmark the scores of the students. There are two ways of viewing this benchmark: the subjects are easy or the students are not "ready" in more than 50% of the skills covered in the tests. These two views may not be mutually exclusive of each other. Also, the 50% benchmark is arbitrary and can be set by the subject-matter experts. However, there is the danger of setting the benchmark too low in order to make it appear that the students performed well when in fact they fail to show readiness in most skills required by the items that they fail to answer correctly[^1]. 
  ...
  - In terms of the non-MCQ tests for Grade 8, more than half of the students who took the tests got more than 50% of the items correctly in all tests except in Social Science (30%). 
  - More than 50% of the Grade 10 test-takers scored 50% or above in all Grade 10 MCQ subjects except in Mathematics (42%) and Physics (36%).
  - In all the non-MCQ tests in STEM, most of the the test-takers got scores below 50%. However, even in Biology, there were only 51% of the test-takers who scored more than 50%. Most notably, there were only 5% of the students how got at least 50% in Mathematics and only 9% of the test-takers got at least 50% in Physics. In all Humanities subjects, more than 50% of the students got at least 50% of the items correctly.
  ...
  - The students also performed worse in Non-MCQ tests in general. This difference is remarkably noticeable for STEM subjects. 
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "SMC"]
```
...
### Distribution of Grade 8 MCQ scores from 2017-2018
...
### Distribution of Grade 10 MCQ scores from 2017-2018
...
### Distribution of Grade 8 Non-MCQ scores from 2017-2018
...
### Distribution of Grade 10 Non-MCQ scores from 2017-2018
