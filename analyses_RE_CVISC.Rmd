---
title: "Analysis of Readiness Examination Scores: CVISC"
date: "10/30/2018"
output:
  word_document: 
...
* The MCQ RE scores for Grade 8 improved from the 2017 scores except for Filipino and Integrated Science.
* There are remarkable improvements in the Grade 8 non-MCQ RE scores for English, Filipino, IS, and Math. No such improvements are visible for Social Science.
* The Grade 10 MCQ scores for Biology, English, Filipino, Social Science and Statistics have also improved when compared to the 2017 scores. These improvements are remarkable. On the other hand, there is an appreciable decrease in the Physics scores. Such decrease is also the trend, system-wide.
* In terms of the Grade 10 non-MCQ tests, English, and Social Science have had a remarkable increase in the distribution of scores. The others either remained the same or have become lower than the previous year.
* In general, the scores for the MCQ tests are normally distributed, except for Grade 10 Math and Physics, where more test takers scored lower than the campus mean than those who didn't. This means that, in the MCQ tests, about 68% of the students scored 1 standard deviation about the mean score. 
* Visible skewness in the distribution of scores can be found in some of the Non-MCQ scores, especially in Integrated Science (Grade 8), and Statistics (Grade 10). In the case of the first, most of the students scored higher than the campus mean score. In the case of the latter, most students scored lower than the campus mean score.
* In the following analyses, 50% is used to benchmark the scores of the students. There are two ways of viewing this benchmark: the subjects are easy or the students are not "ready" in more than 50% of the skills covered in the tests. These two views may not be mutually exclusive of each other. Also, the 50% benchmark is arbitrary and can be set by the subject-matter experts. However, there is the danger of setting the benchmark too low in order to make it appear that the students performed well when in fact they fail to show readiness in most skills required by the items that they fail to answer correctly[^1]. 
  ...
  - In terms of the non-MCQ tests for Grade 8, only 43% of the test-takers scored at least 50% in Social Science while 43% scored at least 50% in Mathematics. On the other hand, 93% of the test-takers got at least 50% of the items correctly in both Filipino and Integrated Science non-MCQ tests.
  - More than 50% of the Grade 10 test-takers scored 50% or above in all Grade 10 MCQ subjects except in Statistics (44%), Physics (32%) and Mathematics (31%). On the other hand, almost all test-takers got a score of more than 50% in English (92%) and Filipino (94%).
  - In all of the Grade 10 non-MCQ tests in STEM, except for Chemistry, below 50% of the test-takers got scores of at least 50%. In Chemistry, there were 51% of the test-takers who scored more than 50%. More worrisome is the fact that in all of the computational subjects, less than 30% got scores of at least 50% (Math---3%; Stat---4%; Physics---26%). However, this is not surprising, as this has been the trend for these subjects in the past years.
...
```{r}
re2015_18 <- setDT(re2015_18)[,stype := case_when(subject %in% c("english", "filipino", "ss")~"Humanities",TRUE~"STEM")][campus == "CVISC"]
```
